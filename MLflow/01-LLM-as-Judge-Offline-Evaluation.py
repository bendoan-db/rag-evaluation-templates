...
# MAGIC To run this demo, just select the cluster `dbdemos-llm-rag-chatbot-ben_doan` from the dropdown menu ([open cluster configuration](https://e2-demo-field-eng.cloud.databricks.com/#setting/clusters/0111-213849-h6d1v07/configuration)). <br />
